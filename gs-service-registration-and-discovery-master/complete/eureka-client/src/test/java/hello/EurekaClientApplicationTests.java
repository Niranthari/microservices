...
import com.virtusa.online.ad.client.OnlineAdServiceClientApplication;
...
@SpringBootTest(classes = OnlineAdServiceClientApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@ActiveProfiles("test")
